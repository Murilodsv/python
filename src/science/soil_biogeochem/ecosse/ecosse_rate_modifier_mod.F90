...
REAL :: one_minus_min  ! One minus a minimum rate.
...
! Array arguments with intent(out)
!-----------------------------------------------------------------------------
REAL, INTENT(OUT) :: water_rate(land_pts,nlayer)
    ! Rate modification factor.
...
!-----------------------------------------------------------------------------
INTEGER :: i, il, j    ! Indices.
REAL :: one_minus_min_dry, one_minus_min_wet  ! One minus various rates.
...
INTEGER, INTENT(IN) :: vs_index(land_pts)
    ! Indices of veg/soil points.
REAL, INTENT(IN) :: soilT_degC(land_pts,nlayer)
    ! Soil temperature (degC).

!-----------------------------------------------------------------------------
! Array arguments with intent(out)
!-----------------------------------------------------------------------------
REAL, INTENT(OUT) :: temp_rate(land_pts,nlayer)
    ! Rate modification factor.
