...
USE soil_ecosse_vars_mod, ONLY:                                               &
  ! imported arrays
  co2_soil_gb, n2o_soil_gb, n2o_denitrif_gb, n2o_nitrif_gb,                   &
  n2o_partial_nitrif_gb, n2_denitrif_gb, n_denitrification_gb,                &
  n_leach_amm_gb, n_leach_nit_gb, n_nitrification_gb, no_soil_gb
...
CALL ecosse_prepare( land_pts, s, triffid_call, vs_pts, vs_index,             &
                     frac_surft_start, nlayer_nitrif, convert_veg_input,      &
                     dt_input,                                                &
