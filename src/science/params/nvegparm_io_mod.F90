...
REAL ::                                                                       &
  ...
  albsnf_nvgu_io(nnvg_max),                                                   &
  albsnf_nvg_io(nnvg_max),                                                    &
  albsnf_nvgl_io(nnvg_max),                                                   &
...
TYPE my_namelist
  SEQUENCE
  REAL :: albsnc_nvg_io(nnvg_max)
  REAL :: albsnf_nvgu_io(nnvg_max)
  REAL :: albsnf_nvg_io(nnvg_max)
  REAL :: albsnf_nvgl_io(nnvg_max)
  REAL :: catch_nvg_io(nnvg_max)
  REAL :: gs_nvg_io(nnvg_max)
  REAL :: infil_nvg_io(nnvg_max)
  REAL :: z0_nvg_io(nnvg_max)
  REAL :: ch_nvg_io(nnvg_max)
  REAL :: vf_nvg_io(nnvg_max)
  REAL :: emis_nvg_io(nnvg_max)
  REAL :: z0hm_nvg_io(nnvg_max)
  REAL :: z0hm_classic_nvg_io(nnvg_max)
