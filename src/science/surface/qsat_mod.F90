...
PRIVATE
PUBLIC :: qsat, qsat_wat, qsat_mix, qsat_wat_mix, l_new_qsat_jules

LOGICAL :: l_new_qsat_jules   = .TRUE.
...
REAL,    INTENT(IN)  :: t(npnts), p(npnts)
REAL,    INTENT(OUT) :: qs(npnts)

! Local scalars
INTEGER              :: itable, i
REAL                 :: atable, fsubw, tt
...
REAL,    INTENT(IN)  :: t(npntsi,npntsj), p(npntsi,npntsj)
REAL,    INTENT(OUT) :: qs(npntsi,npntsj)
INTEGER                            :: j
DO j = 1, npntsj
