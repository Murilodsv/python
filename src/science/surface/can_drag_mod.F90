...
! Module constants
REAL, PARAMETER :: ps_leaf = 1.0
  ! Parameter for sheltering effect (Thom, 1971; QJRMS)
REAL, PARAMETER :: lcrl_max = 2.0
REAL, PARAMETER :: lcrl_min = -2.0
  ! Upper and lower limits of the ratio of adjustment length scale to
  ! MO length.
REAL, PARAMETER :: lai_min = 1.0
  ! Lower limit of plant area index

REAL, PARAMETER :: tol_neutrality = SQRT(EPSILON(tol_neutrality))
  ...
  ! the full expression.
REAL, PARAMETER :: tol_rsl_sim_converge = 1.0e-07
  ! Tolerance for convergence of the iteration for the RSL
  ! similarity function
REAL, PARAMETER :: tol_rsl_converge = 1.0e-03
  ! General tolerance for convergence of the RSL iteration.

REAL, PARAMETER :: min_den_c2mh = 0.02
