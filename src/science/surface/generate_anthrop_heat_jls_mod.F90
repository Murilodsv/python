...
, nsurft, land_points, frac, l_anthrop_heat_src                               &
 )

!Use in module subroutines
USE tilepts_mod, ONLY: tilepts

!Use in module variables
USE jules_surface_types_mod, ONLY: urban, ntype, urban_canyon,                &
                                    urban_roof

USE urban_param, ONLY: wrr_gb, anthrop_heat_scale
...
! Local Variables
INTEGER ::                                                                    &
   surft_index(land_points,ntype),   & ! Index of tile points
...
CALL tilepts( land_points, frac, surft_pts, surft_index )
