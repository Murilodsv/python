...
USE jules_rivers_mod, ONLY:                                                   &
   np_rivers, rivers_boxareas_rp, rfm_rivflow_rp,                             &
   rivers_timestep, rivers_dx, rivers_dlat
...
REAL, PARAMETER :: erf_int_half = 0.5
REAL, PARAMETER :: erf_int_sqrt2 = 1.41421356
