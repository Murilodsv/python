...
!$OMP SHARED(soil_pts,soil_index,tsoil_d,f_wetl,cs_eff,npp,                   &
!$OMP        fch4_wetl_npp,resp_s_tot,fch4_wetl_resps, const_tdep_cs,         &
!$OMP        const_tdep_npp,const_tdep_resps,const_ch4_cs,const_ch4_npp,      &
!$OMP        const_ch4_resps,t0_ch4,fch4_wetl_cs)
DO j = 1,soil_pts
  i = soil_index(j)
