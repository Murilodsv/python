...
REAL, INTENT(IN)    :: t_surft ! temperature (T1P5M) on tile (K).
REAL, INTENT(IN)    :: phot   ! photoperiod (hours).
REAL, INTENT(IN)    :: tt_veg ! thermal requirement of stage 1 of
                              ! crop development (degree days).
REAL, INTENT(IN)    :: tt_rep ! thermal requirement of stage 2 of
                              ! crop development (degree days).

REAL, INTENT(INOUT) :: dvi    ! crop development index

! Local variables
REAL :: teff    ! effective temperature (K)
REAL :: rpe     ! relative photoperiod effect
