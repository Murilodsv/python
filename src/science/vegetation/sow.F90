...
REAL, INTENT(IN) :: t_soil(sm_levels)  ! soil temperatures (K)
REAL, INTENT(IN) :: sthu(sm_levels)    ! soil moisture contents as a fraction of saturation
REAL, INTENT(IN) :: smvcst(sm_levels)  ! Volumetric moisture content at
                                       ! saturation (m3/m3 of soil).
REAL, INTENT(IN) :: smvccl(sm_levels)  ! Volumetric moisture content at
                                       ! critical point (m3/m3 of soil).
REAL, INTENT(IN) :: dphotdt            ! change in photoperiod between this
                                       ! day and the one before, in hours
REAL, INTENT(IN) :: sowdate            ! prescribed sowing date
...
REAL :: smvc(sm_levels) ! Volumetric soil moisture content (m3/m3 of soil).
