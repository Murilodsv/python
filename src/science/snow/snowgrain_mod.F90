...
REAL :: ssa       ! Specific surface area of snow.
REAL :: ssa_0     ! Specific surface area of snow.
REAL :: agrain_et ! Coefficient in fit to rate of growth.
REAL :: bgrain_et ! Coefficient in fit to rate of growth.
