...
INTEGER, PARAMETER :: n_real = 52
INTEGER, PARAMETER :: n_log = 15
...
TYPE my_namelist
  ...
  REAL :: ahmax
  REAL :: dalb_mlt_cice
  REAL :: dalb_mlts_v_cice
  REAL :: dalb_mlts_i_cice
  REAL :: dt_bare_cice
  REAL :: dt_snow_cice
  REAL :: pen_rad_frac_cice
  REAL :: sw_beta_cice
  REAL :: snowpatch
  REAL :: h_freeboard_min
  REAL :: h_freeboard_max
  REAL :: beta_floe
  REAL :: d_floe_min
  REAL :: d_floe_max
  REAL :: ss_floe
...
IF (mype == 0) THEN
  ...
  my_nml % cd_limit_sea       = cd_limit_sea
...
IF (mype /= 0) THEN
  ...
  cd_limit_sea       = my_nml % cd_limit_sea
