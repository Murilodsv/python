...
PUBLIC :: read_nml_jules_model_environment,                                   &
...
CALL jules_print('jules_model_environment',                                   &
                 'Contents of namelist jules_model_environment')

WRITE(lineBuffer, '(A,I0)') 'l_jules_parent = ', l_jules_parent
CALL jules_print('jules_model_environment', lineBuffer)
